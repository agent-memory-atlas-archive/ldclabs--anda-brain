...
use anda_brain::{
    ...
    eval::{
        EvalExperimentReport, EvalGate, EvalProfile, EvalScenario, EvalSuiteReport,
        mine::{MineConfig, mine_scenarios},
        optimize::{BoxedFitness, GenomeKind, OptimizeConfig, OptimizeReport, run_optimize},
        report::{EvalCommandReport, eval_validation_error, optimize_summary, validation_summary},
        run::{
